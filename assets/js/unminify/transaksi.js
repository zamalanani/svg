...
function getNama() {
    $.ajax({
        ...
        success: res => {
            ...
            if (res.nama_produk=='Facial Care'){
                $("#sisa").html(`Sisa ${res.stok}, Ada promo untuk pembelian 2pcs product ini`);
            }else{
    ...
    $.ajax({
        ...
        success: res => {
            let barcode = $("#barcode").val(),
                ...
                if ((nama_produk=='Facial Care')&&(jumlah==2)){
                ...
                jmlbrg = parseInt($("#jmlbrg").val());

            if ((nama_produk=='Facial Care')&&(jumlah==2)&&(disca==null))Swal.fire("Ada discount menarik", "Pilih Kode Promo Sekarang", "warning");
            else{    
